                    	...
                    	<form role="form" action="" method="post" class="f1">
                    		...
                    		<fieldset>
                    			...
                    			<div class="form-group">
                    			    <label class="sr-only" name="first_name">First name</label>
                                    <input type="text" name="first_name" placeholder="First name..." class="first_name form-control" id="first_name">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" name="last_name">Last name</label>
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label class="sr-only" name="package">Package</label>
                                    <select name="package" class="form-control">
				                                <option value="opt1">Select Package Type</option>
				                                <option value="1"></option>
												<option value="2">VIP($25,000 - $99,000)</option>
												<option value="3">Gold VIP($100,000 - $999,000)</option>
												<option value="4">Diamond($1,000,000 - ~)</option>
									</select>
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="exchange_method">Select Exchange Method</label>
                                    <select name="exchange_method" class="form-control">
				                            <option value="opt1">Select Exchange Method</option>
