						...
						<div class="category-content">
							<div class="media">
								...
								<div class="media-body">
									<span class="media-heading text-semibold">larry hoover</span>
					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li class="active"><a href="home.php"><i class="icon-home4"></i> <span>Dashboard</span></a></li><li>
								...
								<li>
									<a href="https://www.triplepenny.com/donations/package-deposit/" target="_blank"><i class="icon-copy"></i> <span>Deposit Now</span></a>
									...
									<a href="withdrawal_request.php"><i class="icon-cube3"></i> <span>Request Withdrawal</span></a>
											...
											<li>
									<a href="view_request.php"><i class="icon-cube3"></i> <span>View Withdrawals</span></a>
									
										
										</li>
                                        <li>
									<a href="update_password.php"><i class="icon-stack2"></i> <span>Change Password</span></a>
                               ...
                               <li>
									...
									<ul>
										<li><a href="referrals.php">Referral Link</a></li>
										<li><a href="view_referrals.php">My Referrals</a></li>
